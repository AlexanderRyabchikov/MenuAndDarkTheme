...
import org.skender.testapp.utils.Movement
import org.skender.testapp.utils.Utils
...
class HiddenSearchWithRecyclerView @JvmOverloads constructor(
    ...
    private fun moveSearchToVisible() {
        ...
        val duration = if (totalMovement != 0 && remainingMovement != 0) {
            ANIM_DURATION / totalMovement * remainingMovement
        } else {
            0
        }
